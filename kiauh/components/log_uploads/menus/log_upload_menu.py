...
class LogUploadMenu(BaseMenu):
    ...
    def set_options(self) -> None:
        self.options = {f'{index}': Option(self.upload, opt_index=f'{index}') for index in range(len(self.logfile_list))}
    ...
    def upload(self, **kwargs):
        try:
            ...
            Logger.print_error(translate('log_upload_failed_5a0b31'))