...
from components.webui_client.client_config.client_config_setup import install_client_config
...
class InstallMenu(BaseMenu):
    ...
    def __init__(self, previous_menu: Type[BaseMenu] | None=None) -> None:
        super().__init__()
        self.title = translate('installation_menu_6deef2')
