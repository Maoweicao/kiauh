...
class DialogType(Enum):
    INFO = (translate('info_9c9cf9'), Color.WHITE)
    SUCCESS = (translate('success_805c3d'), Color.GREEN)
    ATTENTION = ('ATTENTION', Color.YELLOW)
    WARNING = (translate('warning_fd3edc'), Color.YELLOW)
    ERROR = (translate('error_0b99ce'), Color.RED)
    CUSTOM = (None, None)
LINE_WIDTH = 53
BORDER_TOP: str = '┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓'
BORDER_BOTTOM: str = '┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛'
...
class Logger:
    ...
    @staticmethod
    def print_ok(msg: str=translate('success_7ce01f'), prefix=True, start='', end='\n') -> None:
    ...
    @staticmethod
    def print_dialog(title: DialogType, content: List[str], center_content: bool=False, custom_title: str | None=None, custom_color: Color | None=None, margin_top: int=0, margin_bottom: int=0) -> None:
        """
        ...
        if content:
            print(Logger.format_content(content, LINE_WIDTH, color, center_content))
        print(Color.apply(BORDER_BOTTOM, color))
        if margin_bottom > 0:
            print('\n' * margin_bottom, end='')

    @staticmethod
    def _get_dialog_title(title: DialogType, custom_title: str | None=None) -> str | None:
        if title == DialogType.CUSTOM and custom_title:
            return f'[ {custom_title} ]'
        return f'[ {title.value[0]} ]' if title.value[0] else None

    @staticmethod
    def _get_dialog_color(title: DialogType, custom_color: Color | None=None) -> Color:
    ...
    @staticmethod
    def format_content(content: List[str], line_width: int, color: Color=Color.WHITE, center_content: bool=False, border_left: str='┃', border_right: str='┃') -> str:
        ...
        if not center_content:
            formatted_lines = [Color.apply(f'{border_left} {line:<{line_width}} {border_right}', color) for line in lines]
        else:
            formatted_lines = [Color.apply(f'{border_left} {line:^{line_width}} {border_right}', color) for line in lines]
